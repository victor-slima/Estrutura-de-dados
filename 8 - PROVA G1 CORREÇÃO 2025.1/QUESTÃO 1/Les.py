...
class Les:
    ...
    def buscar(self, valor):
        # Busca um valor na lista e retorna seu índice, ou None se não encontrado
        for i in range(self.quant):
    ...
    # Método que remove todos os elementos após o valor selecionado
    def remover_apos(self, valor):
        if self.quant == 0:
            print("Array vazio")
            return 
